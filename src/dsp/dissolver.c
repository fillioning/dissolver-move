...
static int get_param(void *instance, const char *key, char *buf, int buf_len) {
    ...
    if (strcmp(key, "chain_params") == 0) {
        return snprintf(buf, buf_len,
            ...
            "{\"key\":\"noise_mix\",\"short_name\":\"NS MIX\",\"name\":\"Noise Mix\",\"type\":\"float\",\"min\":0,\"max\":1,\"step\":0.01},"
            "{\"key\":\"noise_tone\",\"short_name\":\"NS TON\",\"name\":\"Noise Tone\",\"type\":\"float\",\"min\":0,\"max\":1,\"step\":0.01},"
            "{\"key\":\"stereo_width\",\"short_name\":\"WIDTH\",\"name\":\"Stereo Width\",\"type\":\"float\",\"min\":0,\"max\":1,\"step\":0.01},"
            "{\"key\":\"grain_jitter\",\"short_name\":\"COMP\",\"name\":\"Compress\",\"type\":\"float\",\"min\":0,\"max\":1,\"step\":0.01},"
            "{\"key\":\"evo_depth\",\"short_name\":\"DEPTH\",\"name\":\"Spread Depth\",\"type\":\"float\",\"min\":0,\"max\":1,\"step\":0.01},"
            "{\"key\":\"feedback_cap\",\"short_name\":\"Cap\",\"name\":\"Feedback Cap\",\"type\":\"float\",\"min\":0,\"max\":1,\"step\":0.01},"
            "{\"key\":\"tilt_freq\",\"short_name\":\"TILT\",\"name\":\"Tilt Freq\",\"type\":\"float\",\"min\":0,\"max\":1,\"step\":0.01},"
            "{\"key\":\"output_level\",\"short_name\":\"OUT\",\"name\":\"Output Level\",\"type\":\"float\",\"min\":0,\"max\":1,\"step\":0.01},"
            "{\"key\":\"attack_time\",\"short_name\":\"Attack\",\"name\":\"Attack Time\",\"type\":\"float\",\"min\":0,\"max\":1,\"step\":0.01},"
            "{\"key\":\"release_time\",\"short_name\":\"Release\",\"name\":\"Release Time\",\"type\":\"float\",\"min\":0,\"max\":1,\"step\":0.01}"
            "]");
    }
